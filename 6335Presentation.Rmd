...
.panel[.panel-name[Leaflet Analysis]
...
us <- test %>% 
  ...
  labs(x = "Year",
      y = "Number of movies",
      title = "Trend of Bechdel Results in the USA") +
  guides(fill=guide_legend(title="Test"))+
  scale_fill_manual(values = c(pass = "#95D196", 
                               dubious = "#F5B7B1", 
                               men = "#F1948A",
...
- USA has the highest number of movie production

- **Movie boom** and **higher passing rate** since 1990s

- **Higher female participation** BUT **only supportive role**
...
budget_plot <- movies_clean %>% 
  ...
  theme_classic() +
  labs(title = "The Bechdel test with respect to the average films budget",
      caption = "Figure 5",
...
2. Less gender biased in **German and Spanish movies**

3. **Relatively higher female participation** in the USA, but **only supporting role**(No conversations between them)

--

4. Female plays relatively important role in **horror, comedy and drama** genre

--

5. Results of the test are **not affected by runtime**

--

6.  Investors of Movie industry invested more in the **male dominant movies**

--

7. Movies with **female participation** tend to have **relatively higher profit**

--

8. Data **coverage is not enough** 

<img src= "plots/cinderella.png" width = "37%"> <img src= "plots/batman.jpeg" width = "42%">
